<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionPlan.aspx.cs" Inherits="NBDSite.ProductionPlan" %>
    ...
    <div>
        ...
        <fieldset>
            ...
            <table class="auto-style19">
                ...
                <tr>
                    ...
                    <td class="auto-style20">
                        <asp:TextBox ID="txtProjectStart" runat="server" Width="225px" ValidationGroup="Project" placeholder="MM/DD/YYYY"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style20">
                        <asp:TextBox ID="txtProjectEnd" runat="server" Width="225px" ReadOnly="True" placehodler="MM/DD/YYYY"></asp:TextBox>
                    </td>
                    <td class="auto-style15">
                        &nbsp;</td>
                    <td>
        ...
        <fieldset>
            ...
            <table class="auto-style19">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtProduction" runat="server" Width="509px" Height="18px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
            ...
            <table class="auto-style19">
                ...
                <tr>
                    <td class="auto-style21">
                        <asp:Button ID="btnAddPlant" runat="server" Text="+" OnClick="btnAddPlant_Click" />
                    </td>
                    <td class="auto-style22">
                        <asp:TextBox ID="txtPlantQ" runat="server" Width="50px"></asp:TextBox>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtPlantQ" ErrorMessage="*" ForeColor="Red" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                    </td>
                ...
                <tr>
                    <td class="auto-style12">
                        <asp:Button ID="btnAddPottery" runat="server" Text="+" OnClick="btnAddPottery_Click" />
                    </td>
                    <td class="auto-style13">
                        <asp:TextBox ID="txtPotteryQ" runat="server" Width="50px"></asp:TextBox>
                        <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtPotteryQ" ErrorMessage="*" ForeColor="Red" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                    </td>
                    <td class="auto-style14">
                        <asp:DropDownList ID="ddlPottery" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPottery_SelectedIndexChanged">
                            <asp:ListItem Selected="True" Value="-1">Select...</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style15">
                ...
                <tr>
                    <td class="auto-style26">
                        <asp:Button ID="btnMaterials" runat="server" Text="+" OnClick="btnMaterials_Click" />
                    </td>
                    <td class="auto-style27">
                        <asp:TextBox ID="txtMaterialQ" runat="server" Width="50px"></asp:TextBox>
                        <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtMaterialQ" ErrorMessage="*" ForeColor="Red" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                    </td>
                ...
                <tr>
                    <td class="auto-style12">
                        <asp:Button ID="btnAddTool" runat="server" Text="+" OnClick="btnAddTool_Click" />
                    </td>
                    <td class="auto-style1">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAddDesign" runat="server" OnClick="btnAddDesign_Click" Text="+" />
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAddProd" runat="server" OnClick="btnAddProd_Click" Text="+" />
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAddHeo" runat="server" OnClick="btnAddHeo_Click" Text="+" />
                    </td>
                    <td>
